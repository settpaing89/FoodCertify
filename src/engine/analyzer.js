...
export const CONDITIONS = [
  { id: 'diabetes',    label: 'Diabetes',       icon: '🩺', color: '#e53935', bg: '#fce4ec' },
  { id: 'gluten',      label: 'Gluten Allergy', icon: '🌾', color: '#f57c00', bg: '#fff3e0' },
  { id: 'peanut',      label: 'Peanut Allergy', icon: '🥜', color: '#6d4c41', bg: '#efebe9' },
  { id: 'vegan',       label: 'Vegan',          icon: '🌿', color: '#2e7d32', bg: '#e8f5e9' },
  { id: 'vegetarian',  label: 'Vegetarian',     icon: '🥗', color: '#558b2f', bg: '#f1f8e9' },
];
